...
int main()
{
	...
	//randomInit(h_V1, Grid_Width, Grid_Height, Substance_U);
	//randomInit(h_V2, Grid_Width, Grid_Height, Substance_V);
    
    PointInit(h_V1, Grid_Width, Grid_Height, Substance_U);
    PointInit(h_V2, Grid_Width, Grid_Height, Substance_V);
    ...
    /*----------Create Buffer Objects for the two variables on the device-----*/
